...
function preload() {
  titleImage = loadImage("./assets_2/IMG_1201.png");
...
function drawStartScreen() {
  ...
  let ratio = titleImage.width / titleImage.height;
  ...
  textAlign(CENTER, CENTER)
  textSize (28);
  text("Click Anywhere To Start", width / 2, height * 0.8);
}
